//! Train PPO on CartPole-v1 (Long GPU Training)
//!
//! This example demonstrates extended RL training on GPU using Thrust.
//! It trains a PPO agent to solve the CartPole environment with more
//! environments and timesteps for better convergence.
//!
//! # Usage
//!
//! ```bash
//! # On GPU machine
//! cargo run --example train_cartpole_long --release
//! ```
...
fn main() -> Result<()> {
    ...
    tracing::info!("Environment: CartPole-v1 (GPU Training)");
    ...
    // Save model
    let save_path = "cartpole_model_long.pt";
